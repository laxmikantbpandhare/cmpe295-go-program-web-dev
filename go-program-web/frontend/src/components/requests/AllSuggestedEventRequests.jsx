...
class AllSuggestedEventRequests extends Component{
    constructor(props){
        super(props);
        this.state = {
            searchEventName: "",
...
const mapStateToProps = state => {
    return {
        ...
        responseStatus: state.suggestedEventsRequests.getResponseStatus,
        events: state.suggestedEventsRequests.events
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(AllSuggestedEventRequests);