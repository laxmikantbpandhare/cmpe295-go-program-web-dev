...
const ViewSuggestedEventRequestModal = (props) => {
    ...
    const hideModal = e => {
        props.hideViewSuggestedEventRequestModal();
    }
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            <div className="modal-body">
                                ...
                                <div class="row">
                                    <label className="col-3"><strong>Suggested</strong></label>
                                    <div className="col-9">
...
export default ViewSuggestedEventRequestModal;