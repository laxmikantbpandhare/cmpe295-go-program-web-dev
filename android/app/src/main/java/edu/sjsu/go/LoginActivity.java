...
public class LoginActivity extends AppCompatActivity {
    ...
    private String TAG_ACTIVITY = "LoginActivity";
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Log.d(TAG_ACTIVITY, jsonReq.toString());

            Ion.with(this)
                    .load("POST", ConstantUtils.DOMAIN_URL + "user/login")
                    .setJsonObjectBody(jsonReq)
                    .asString()
                    .setCallback(new FutureCallback<String>() {
                        @Override
                        public void onCompleted(Exception e, String result) {
                            Log.d(TAG_ACTIVITY, "Result " + result);
                            if (e == null) {
